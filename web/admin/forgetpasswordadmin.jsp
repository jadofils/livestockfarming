...
<label for="otp">Verify You are Not Robot with user id:</label>
<input type="text" name="otp" id="otp" placeholder="Enter your User Id" class="otp">

<div class="btnRegister">

    <input type="submit" value="Forget Password">
</div>
Try is changed success? <a href="loginAdmin.jsp">Login</a>
    </form>
